...
public section.
  ...
  types:
    begin of FALV_S_RO01,
    ROW_ID type i,
    outputlen type i,
    END OF FALV_S_RO01 .
  types:
    FALV_T_RO01 TYPE TABLE OF FALV_S_RO01 .
  types:
  ...
  CONSTANTS fc_continue TYPE sy-ucomm VALUE 'CONTINUE' ##NO_TEXT.
  ...
  methods SET_MERGE_VERTICALLY
    importing
      !COL type I
      !TAB_ROW_MERGE type FALV_T_RO01 .
    " methods Z_DISPLAY .
  ...
  methods GET_REGISTERED_F4_FOR_FIELDS
    returning
      value(F4) type LVC_T_F4 .
...
*                                  e_built_in_screen      = data(built_in_screen)
  ...
  METHOD evf_user_command.
    CASE e_ucomm.
      WHEN fc_back OR fc_exit OR fc_up OR fc_cancel OR fc_continue.
        LEAVE TO SCREEN 0.
